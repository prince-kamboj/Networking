...
Understanding IPv4 addressing is essential for cybersecurity professionals because IP addresses are used in:
...
IPv4 (Internet Protocol Version 4) is a 32-bit logical addressing system used to identify devices on a network.
...
### What is the range of one octet?
...
A **public IP** is globally routable on the Internet, while a **private IP** is used within local networks and is not directly accessible from the Internet.
...
It identifies which part of the IP address represents the network and which part represents the host.

---

### What is a default gateway?

A router that forwards traffic from the local network to other networks.
...
- Routers use the default gateway to forward traffic.
- DNS translates domain names into IP addresses.
- Understanding IPv4 is essential for networking and cybersecurity.