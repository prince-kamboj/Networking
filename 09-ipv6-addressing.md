...
- Disable unused IPv6 if not required
- Monitor ICMPv6 traffic
- Scan IPv6 networks using tools like `nmap`
- Understand IPv6 tunneling mechanisms (e.g., Teredo, 6to4), as they can bypass security controls if unmanaged.
...
IPv6 is the latest version of the Internet Protocol that uses 128-bit addresses.

---

### Why was IPv6 introduced?

To solve IPv4 address exhaustion and improve networking capabilities.
...
### How many blocks does an IPv6 address contain?

8 blocks.

---

### Which numbering system does IPv6 use?
...
To automatically configure IPv6 addresses without requiring a DHCP server.
...
- An IPv6 address contains **8 groups** of 16 bits each.
...
- **/64** is the most common network prefix.
- IPv6 provides a vastly larger address space than IPv4.
- Learning IPv6 is essential for modern networking and cybersecurity.